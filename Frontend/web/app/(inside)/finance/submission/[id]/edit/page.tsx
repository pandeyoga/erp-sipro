...
export default function EditConstractionPage() {
  ...
  const handleDelete = async () => {
    if (!selected) return;
    try {
      await axios.delete(`/finance/submission/transaction/${selected.transaction_id}`);
      handleReload()
  ...
  return (
    <div>
      <h1 className="text-xl font-bold text-gray-600 mb-6">Update Submission</h1>
      <SubmissionForm id={id} mode="edit" handleReload={handleReload}/>
      <DataTable
        ref={TableRef}
